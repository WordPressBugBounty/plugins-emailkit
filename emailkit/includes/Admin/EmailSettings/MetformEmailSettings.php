        ...
        <div id="need-emailkit-pro-btn-wrap" class="emailkit-metform-btn need-emailkit-pro-btn">
            <div class="emailkit-upgrade-notice">
                <span class="emailkit-upgrade-text">
                    <?php
                    printf(
                        /* translators: %s: "EmailKit Pro" product name, wrapped in a <strong> tag. */
                        esc_html__( 'Get %s - the drag-and-drop builder to customize your confirmation emails.', 'emailkit' ),
                        '<strong>' . esc_html__( 'EmailKit Pro', 'emailkit' ) . '</strong>'
                    );
                    ?>
                </span>
                <a class="upgrade-button" target="_blank" href="https://wpmet.com/plugin/emailkit/pricing/">
                    ...
                    </span> <?php esc_html_e( 'Upgrade to Pro', 'emailkit' ); ?>
                </a>
            </div>
            ...
            <div class="info-tooltip">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                    ...
                    <div class="metform-info-tooltip-text">
                        <?php esc_html_e( "Customize your form confirmation email with EmailKit's drag and drop builder.", 'emailkit' ); ?>
                    </div>
